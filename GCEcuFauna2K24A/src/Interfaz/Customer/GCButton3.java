...
public class GCButton3 extends JButton implements MouseListener {
    public GCButton3(String text){
        customizeComponent(text);
    }
    public GCButton3(String text, String iconnew){
    ...
    public void customizeComponent(String text) {
        ...
        setFont(GCIAStyle.GCFONT_BOLD3);
