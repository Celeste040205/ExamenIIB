...
public class GCDTOTipoHormiga {
    ...
    public GCDTOTipoHormiga(){}


    public GCDTOTipoHormiga(Integer gcRowNum, Integer gcIdCatalogo, Integer gcIdCatalogoTipo, String gcNombre,
